...
export const questionSchema = z.object({
  course: z.string(), questionText: z.string().min(2),
  ...
  topic: z.string().optional(), explanation: z.string().optional(), status: z.enum(["ACTIVE", "INACTIVE"]).optional()
...
export const questionUpdateSchema = z.object({
  questionText: z.string().min(2).optional(), options: z.array(option).min(2).optional(), correctAnswer: z.array(z.string()).min(1).optional(),
  marks: z.coerce.number().positive().optional(), difficulty: z.enum(["EASY", "MEDIUM", "HARD"]).optional(), topic: z.string().optional(),
