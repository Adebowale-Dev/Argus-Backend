...
export const createUserSchema = z.object({
  ...
  permissions: z.array(z.enum(PERMISSION_VALUES)).default([]), department: z.string().optional()
});
export const updateUserSchema = z.object({ fullName: z.string().min(2).optional(), username: z.string().min(3).optional(), department: z.string().nullable().optional(), permissions: z.array(z.enum(PERMISSION_VALUES)).optional() });
